...
import { UpdateRoomModal } from '../PopUpEditRoom/PopUpEditRoom';
  ...
  export const RoomComponent: React.FC = () => {
    ...
    const columns: Column<Room>[] = [
        ...
        { headerColumn: 'Offer Price', columnsData: 'OfferPrice' },
        {
          headerColumn: 'Status',
          columnsData: 'Status',
          columnRenderer: (row: Room) => <StatusButton status={row.Status}>{row.Status}</StatusButton>
        },
    ...
    const filterActions = {
      ...
      booked: () => setFilteredRooms(roomList.filter((room) => room.Status === 'Unavailable'))
    };
